		        ...
		        <ul>
		        	...
		        	<li>
		                ...
		                <dl>
		                	...
		                	<dt><a href="javascript:void(0)" onclick="menuCAClick('${pageContext.request.contextPath}/repertory_repertoryall2',this, 'page10074')">入库管理</a></dt>
		           	...
		           	<li>
		                ...
		                <dt><a href="javascript:void(0)" onclick="menuCAClick('${pageContext.request.contextPath}/tgls/order/order_addList.jsp',this, 'page10076')">采购药品结算</a></dt>
		                	<dt><a href="javascript:void(0)" onclick="menuCAClick('${pageContext.request.contextPath}/tgls/order/order_findAllOrder',this, 'page10077')">采购订单列表</a></dt>
		           ...
		           <li>
		                ...
		                <dl>
		                	<dt><a href="javascript:void(0)" onclick="menuCAClick('${pageContext.request.contextPath}/tgls/reportForm/reportForm.jsp',this, 'page10035')">订单统计报表</a></dt>
		                </dl>
		           	</li>
