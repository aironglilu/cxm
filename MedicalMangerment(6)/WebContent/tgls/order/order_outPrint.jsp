			...
			<div class="layui-row" id="dayindaju1">
				<table class="layui-table printTable">
					<tbody>
						...
						<tr>
						<td class="textCenter"><s:property value="#orderItem.orName"></s:property></td>
						<td class="textCenter"><s:property value="#orderItem.orUnitPrice"></s:property></td>
						<td class="textCenter"><s:property value="#orderItem.orValDate"></s:property></td>
						<td class="textCenter"><s:property value="#orderItem.orProductDate"></s:property></td>
						<td class="textCenter"><s:property value="#orderItem.ornum"></s:property></td>
						<td class="textCenter"><s:property value="#orderItem.tname"></s:property></td>
						<td class="textCenter"><s:property value="#orderItem.sname"></s:property></td>
						<td class="textCenter"><s:property value="#orderItem.orsum"></s:property></td>
						</tr>
						</s:iterator>
						<tr>
							<td class="printOperator" colspan="8">
								<span>总价：￥<s:property value="#session.orderShop.total"></s:property>元</span>
								<span class="right"><a href="${pageContext.request.contextPath}/order_addOrder"><button style="float: right" class="layui-btn layui-btn-normal"  type="submit">确认订单</button></a></span>
							</td>
						</tr>
					</tbody>
				</table>
