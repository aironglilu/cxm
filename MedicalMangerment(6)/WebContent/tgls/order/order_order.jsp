...
//					    	,type: 'datetime'	//开启时分秒
			...
			<table class="layui-table">
				...
				<s:iterator value="list" var="list">
					<tr>
						<td><s:property value="#list.orderCode"></s:property></td>
						<td><s:property value="#list.orderSum"></s:property>元</td>
						<td><s:property value="#list.orderDate"></s:property></td>
						<td><s:property value="#list.orderName"></s:property></td>
						<td>
							<a href="${pageContext.request.contextPath}/order_findOrderDetail?orderCode=<s:property value="#list.orderCode"></s:property>"><button class="layui-btn layui-btn-sm layui-btn-warm" lay-submit  type="submit">订单详情</button></a>
						</td>
					</tr>
				</s:iterator>
				</tbody>
