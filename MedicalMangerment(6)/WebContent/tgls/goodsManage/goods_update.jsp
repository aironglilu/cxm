	...
	<body>
		<div class="cBody">
			<form id="addForm" class="layui-form" method="post" action="${pageContext.request.contextPath}/goods_updateGoods" onsubmit="return checkform()">
				...
				<div class="layui-form-item">
					<label class="layui-form-label">库存数量暂无</label>
					<div class="layui-input-block">
						<input type="number" name="" lay-verify="required|number" autocomplete="off" class="layui-input" placeholder="请输入数字" value="<s:property value="goods.gid"/>">
					</div>
				</div>
